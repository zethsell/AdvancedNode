...
describe('PgConnection', () => {
  ...
  it('should return ConnectionNotFoundError on disconnect if coneection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on openTRansaction if coneection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on closeTransaction if coneection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on commit if coneection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on rollback if coneection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on get repository if coneection is not found', async () => {
    expect(rollbackTransactionSpy).not.toHaveBeenCalled()
