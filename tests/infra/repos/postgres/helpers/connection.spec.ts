...
describe('PgConnection', () => {
  ...
  it('should return ConnectionNotFoundError on disconnect if conection is not found', async () => {
  ...
  it('should return ConnectionNotFoundError on openTRansaction if conection is not found', async () => {
  ...
  it('should get repository from typorm', async () => {
    await sut.connect()
    const repository = sut.getRepository(PgUser)
    expect(getRepositorySpy).toHaveBeenCalledWith(PgUser)
    expect(getRepositorySpy).toHaveBeenCalledTimes(1)
  ...
  it('should return ConnectionNotFoundError on get repository if conection is not found', async () => {
    expect(rollbackTransactionSpy).not.toHaveBeenCalled()
